	...
	Autocomplete.prototype = {
		...
		getSuggestions: function (q) {
			...
			if (cr && $.isArray(cr.suggestions)) {
				...
				$.get(this.serviceUrl, me.options.params, function (txt) { me.processResponse(txt); },type);
			}
		},
		...
		processResponse: function (text) {
			...
			*/
			//alert(text);
			//console.log(text);
			var response = text.autocomplete;
			...
			if (response.query.toLowerCase() === this.getQuery(this.currentValue.toLowerCase())) {
		...
		select: function (i) {
			...
			if (selectedValue) {
				this.el.focus().val(selectedValue);
				$(this.el).setCursorPosition(selectedValue.length);
				...
				this.hide();
				this.onSelect(i);
//				$(this.el).focus().setCursorPosition(selectedValue.length);
			}
		},
